...
def cornersHeuristic(state, problem):
    ...
    """
    corner1, corner2, corner3, corner4 = problem.corners # These are the corner coordinates
    ...
    if not corner2Visited:
        distanceList.append(util.manhattanDistance(position, corner2))
    if not corner3Visited:
        distanceList.append(util.manhattanDistance(position, corner3))
    if not corner4Visited:
        distanceList.append(util.manhattanDistance(position, corner4))
